...
=======
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">5.1 Our Rights</h3>
>>>>>>> e15fe06 (Initial commit)
          <p className="text-gray-600 mb-4">
...
=======
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">5.2 Your Content</h3>
>>>>>>> e15fe06 (Initial commit)
          <p className="text-gray-600 mb-4">
...
=======
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">7.1 Subscription Fees</h3>
>>>>>>> e15fe06 (Initial commit)
          <p className="text-gray-600 mb-4">
...
=======
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">7.2 Billing and Renewal</h3>
>>>>>>> e15fe06 (Initial commit)
          <p className="text-gray-600 mb-4">
...
=======
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">8.1 Service Availability</h3>
>>>>>>> e15fe06 (Initial commit)
          <p className="text-gray-600 mb-4">
...
=======
          <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">8.2 Limitation of Liability</h3>
>>>>>>> e15fe06 (Initial commit)
          <p className="text-gray-600 mb-4">
...
=======
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">11. Governing Law and Dispute Resolution</h2>
>>>>>>> e15fe06 (Initial commit)
          <p className="text-gray-600 mb-4">
